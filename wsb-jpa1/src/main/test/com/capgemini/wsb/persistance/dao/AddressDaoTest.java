...
public class AddressDaoTest
{
    ...
    public void testShouldFindAddressById() {
        ...
        assertThat(addressEntity.getPostalCode()).isEqualTo("40-400");
    }
    ...
    public void testShouldSaveAddress() {
        ...
        addressEntity.setAddressLine1("adres1");
        addressEntity.setAddressLine2("adres2");
        addressEntity.setCity("warszawa");
        addressEntity.setPostalCode("10-100");
    ...
    public void testShouldSaveAndRemoveAddress() {
        // given
        AddressEntity addressEntity = new AddressEntity();
        addressEntity.setAddressLine1("adrespierwszy");
        addressEntity.setAddressLine2("adresdrugi");
        addressEntity.setCity("krakow");
        addressEntity.setPostalCode("20-200");
